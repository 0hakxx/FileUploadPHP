<?
  ...
  if($menu == "notice") {
    setcookie("menu", "notice");
  } else if($menu == "contact") {
    setcookie("menu", "contact");
  } else {
    $menu = $_COOKIE["menu"];
  }
?>
      ...
      <nav class="navbar navbar-default">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li <? if($taskPage == "list.php" && $menu == "notice") echo("class=\"active\""); ?>><a href="index.php?page=list&menu=notice">공지사항</a></li>
            <li <? if($taskPage == "list.php" && $menu == "contact") echo("class=\"active\""); ?>><a href="index.php?page=list&menu=contact">문의사항</a></li>
          </ul>
        </div><!-- /.navbar-collapse -->
        </div><!-- /.container-fluid -->
      </nav>
